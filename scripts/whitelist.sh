...
curl -sS https://raw.githubusercontent.com/raghavdua1995/DNSlock-PiHole-whitelist/master/whitelist.list | sudo tee -a "${PIHOLE_LOCATION}"/whitelist.txt >/dev/null
